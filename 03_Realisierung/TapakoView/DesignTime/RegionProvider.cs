...
{    
    ...
    public class RegionProvider
    {
        ...
        public static readonly DependencyProperty ViewProviderProperty =
            DependencyProperty.RegisterAttached("ViewProvider", typeof (DesignTimeViewProviderBase),
                typeof (RegionProvider), new PropertyMetadata(null, ViewProvider_Changed));
        ...
        private static void ViewProvider_Changed(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                return;
            } //we're in run-time, so the rest is not necessary  
