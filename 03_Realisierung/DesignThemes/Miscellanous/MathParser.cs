...
namespace Tapako.Design.Miscellanous
{
	...
	public sealed class MathParser
	{
		#region StaticRegisterFunction - Many, many overloads
			...
			private static readonly ConcurrentDictionary<string, _FunctionWithParameterCount> _staticFunctions = new ConcurrentDictionary<string, _FunctionWithParameterCount>();
			public static void StaticRegisterFunction(Func<double> function)
			{
				StaticRegisterFunction(null, function);
			}
			public static void StaticRegisterFunction(Func<double, double> function)
			{
				StaticRegisterFunction(null, function);
			}
			public static void StaticRegisterFunction(Func<double, double, double> function)
			{
				StaticRegisterFunction(null, function);
			}
			public static void StaticRegisterFunction(Func<double, double, double, double> function)
			{
				StaticRegisterFunction(null, function);
			}
			...
			public static void StaticRegisterFunction(string name, Func<double> function)
			{
				StaticRegisterFunction(name, (Delegate)function);
			}
			public static void StaticRegisterFunction(string name, Func<double, double> function)
			{
				StaticRegisterFunction(name, (Delegate)function);
			}
			public static void StaticRegisterFunction(string name, Func<double, double, double> function)
			{
				StaticRegisterFunction(name, (Delegate)function);
			}
			public static void StaticRegisterFunction(string name, Func<double, double, double, double> function)
			{
				StaticRegisterFunction(name, (Delegate)function);
			}
			public static void StaticRegisterFunction(string name, Delegate function)
			{
				...
				if (method.ReturnType != typeof(double))
					throw new ArgumentException("function must have a return type of double.", "function");
				...
				foreach(var parameter in invokeParameters)
					if (parameter.ParameterType != typeof(double))
						throw new ArgumentException("The parameter " + parameter.Name + " of the given function isn't of type double.", "function");
		...
		#region RegisterFunction - Many, many overloads
			public void RegisterFunction(Func<double> function)
			{
				RegisterFunction(null, function);
			}
			public void RegisterFunction(Func<double, double> function)
			{
				RegisterFunction(null, function);
			}
			public void RegisterFunction(Func<double, double, double> function)
			{
				RegisterFunction(null, function);
			}
			public void RegisterFunction(Func<double, double, double, double> function)
			{
				RegisterFunction(null, function);
			}
			...
			public void RegisterFunction(string name, Func<double> function)
			{
			...
			public void RegisterFunction(string name, Func<double, double, double> function)
			{
				RegisterFunction(name, (Delegate)function);
			}
			public void RegisterFunction(string name, Func<double, double, double, double> function)
			{
				RegisterFunction(name, (Delegate)function);
			}
		...
		private readonly Dictionary<string, MathVariable> _variables = new Dictionary<string, MathVariable>();
		private readonly Dictionary<string, _FunctionWithParameterCount> _functions = new Dictionary<string, _FunctionWithParameterCount>();
		...
		public Expression<Func<double>> Parse(string expression)
		{
			...
			var lambda = Expression.Lambda<Func<double>>(currentExpression);
			return lambda;
		}
		...
		private static readonly PropertyInfo _valueProperty = typeof(MathVariable).GetProperty("Value");
		...
		private sealed class _Token
		{
			...
			internal _Token(_TokenType tokenType, string text, int characterIndex):
				this(tokenType, text, characterIndex, 0.0)
			{
			}
			internal _Token(_TokenType tokenType, string text, int characterIndex, double value)
			{
		...
		private static int _ParseNumber(int startPosition, string expression, List<_Token> result)
		{
			...
			double doubleValue = double.Parse(numberPart, CultureInfo.InvariantCulture);
			result.Add(new _Token(_TokenType.Value, numberPart, startPosition, doubleValue));
			return position;
		}
